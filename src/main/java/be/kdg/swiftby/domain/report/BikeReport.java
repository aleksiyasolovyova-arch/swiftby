    ...
    public class BikeReport {
        ...
        public BikeReport(LocalDateTime reportTime, int mileage, int assistanceLevel, String technicianComment,
                          AxialSensorData axialSensorData, BatteryData batteryData, MotorData motorData,
                          PedalData pedalData, TestBenchData testBenchData, WheelData wheelData, BikeInstance bike) {
